...
<?php include 'menu.php';?>
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Tablas de Simulación</h1>
          <p class="mb-4">Por favor verificar muy bien los datos y cálculos antes de realizar la emisión del impuesto predial .</p>
       <form method="POST" id="Frm_Simular">
          <!-- DataTales Example -->
          <div class="card shadow mb-5">
            <div class="card-header py-3">
              <h6 id="Titulo" class="m-0 font-weight-bold text-primary">Datos Catastrales</h6>
            </div>
            <div class="card-body">
                    <div class="form-group row">
                                     ...
                                     <div class="col-xl-4 col-lg-4">         
                                                    <div class="wrap-input100 input100-select bg1" data-validate="Seleccione una Opción">
                                                        <span class="label-input100">Seleccione el impuesto a Simular</span>
                                                        <div>
                                                                <select class="js-select2" name="cmb_impuesto" id="cmb_impuesto">
                                                                         <option>Simulacion Actual</option>
                                                                        <option value="1">Urbano</option>
                                                                        <option value="2">Rural</option>
                                                                        <option value="3">Derechos y Acciones</option>
                                                                </select>
                                                                <div class="dropDownSelect2"></div>
                                                        </div>
                                                </div>
              ...
              <div class="table-responsive">
                <table class="table table-bordered" id="dataCatastro" width="100%" cellspacing="0">
                  <thead>
                    <tr>
                      ...
                      <th>Serv.Admin</th>
                      <th>A Pagar</th>
                      <th>Propietarios Porcentajes</th>
                    </tr>
                  </thead>
                  <tfoot>
                    <tr>
               ...
               <div class="card-body">   
<!--                  <a id="Btn_Valorar" href="#" class="btn btn-primary btn-icon-split">
                    <span class="icon text-white-50">
                      <i class="fas fa-dollar-sign"></i>
                    </span>
                    <span class="text">Valorar</span>
                  </a>-->
                   <a id="Btn_simular" href="#" class="btn btn-success btn-icon-split">
                    <span class="icon text-white-50">
                      <i class="fab fa-sellsy"></i>
                    </span>
                    <span class="text">Simular</span>
                  </a>
                   <a id="Btn_Generar" href="#" class="btn btn-warning btn-icon-split">
                    <span class="icon text-white-50">
                      <i class="fas fa-download"></i>
                    </span>
                    <span class="text">Generar Archivo</span>
                  </a>
                  <a id="Btn_Emitir" href="#" class="btn btn-danger btn-icon-split">
                    <span class="icon text-white-50">
                      <i class="fas fa-file-import"></i>
                    </span>
                    <span class="text">Emitir</span>
                  </a>
                   <a id="Conta" href="#" class="btn btn-danger btn-icon-split">
...
<div class="modal fade" id="Wait" role="dialog" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <div class="text-center"><i class="fa fa-spin fa-spinner"></i> Ejecutando Simulacion Espere Por Favor...</div>
...
<!--===============================================================================================-->
  ...
  <script src="js/Simulacion_r.js?%=Guid.NewGuid()%"></script>
