...
<?php include 'menu.php';?>
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Reportes de Trámites Archivados</h1>
          <p class="mb-4">Reporte de Trámites Archivados por Usuario.</p>
       <form method="POST" id="Frm_Simular">
          <!-- DataTales Example -->
          <div class="card shadow mb-5">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Tramites Archivados</h6>
            </div>
            <div class="card-body">
...
<!--  </div>-->
 ...
 <div class="modal fade" id="Form_Recorrido" role="dialog">
  ...
  <script src="js/Archivados.js?%=Guid.NewGuid()%"></script>
