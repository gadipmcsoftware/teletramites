...
$COD_EST_TRA     = $_REQUEST["cod_est_tra"];
$NAME            = $_REQUEST["name"];
$CLAVE_CATASTRAL = $_REQUEST["clave_catastral"];
$OBSE_TRAMITE    = $_REQUEST["obse_tramite"];
$NUM_NOTIFI      = $_REQUEST["num_notifi"];
$COD_SUB_TRA     = $_REQUEST["cod_sub_tra"];
//PARAMETROS SP
