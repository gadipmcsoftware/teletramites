...
////                    
    ...
    $('.validate-form').on('submit',function(){
        evento='submit';
         ...
         var check = true;
         var num_adj=parseInt(sessionStorage.getItem('num_adj'));
         var Ext=sessionStorage.getItem('Usr_Ext');
        if (num_adj==0&&Ext==1){
            check=false;
            $('.btn-primary').removeClass("btn-primary").addClass('btn-dark');
             bootbox.dialog({
                                                                                           ...
                                                                                           message: "Error. Se debe subir los requisitos necesarios para el trámite",
                                                                                           onEscape: function() {
                                             ...
                                             email=sessionStorage.getItem('EMAIL_PROFE');
                                              ...
                                              if (rowProfe.length==0){
                                                         var DataSetTramiteaux=JSON.parse(sessionStorage.getItem('Tramites'));
                                                          ...
                                                          email=DataSetTramite[0][9];
                                                         CedProfe =DataSetTramite[0][6];
      //                                                   alert(DataSetTramite[0][6])
                                                         DatosProfecional(CedProfe);
                                                          var notifi=rowProfe[0][5];
                                                }
                                                 else{
