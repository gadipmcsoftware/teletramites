...
//detalle
        $('#Tbl_Consulta tbody').on('click', 'a', function () {
            ...
            if ($(this).attr('id') == "Btn_VerDetalle") {
                ...
                $("#txt_nombreimpuestoMejora").attr("value", "CONTRIBUCION ESPECIAL DE MEJORAS");
                $("#Txt_clavecatastral").attr("placeholder", rowDataVerDetalle[3]);//clave catastral
                 $("#Txt_clavecatastral2").attr("placeholder", rowDataVerDetalle[3]);//clave catastral
                $("#Txt_direccion").attr("value", rowDataVerDetalle[4]);
                $("#Txt_numCuota").attr("value", rowDataVerDetalle[4]);//total
                ...
                $("#Txt_canon").attr("placeholder", rowDataVerDetalle[21]);//total
                ...
                $("#Txt_pat_multa").attr("value", rowDataVerDetalle[25]);//multa en solares
                ...
                $("#txt_numemision2").attr("placeholder", rowDataVerDetalle[28]);//propiedad OK--- 28
    ...
    try {
        ...
        if (ind_form) {
            ...
            $.ajax({
                ...
                async: false,
                cache: false,
                url: "http://172.23.25.6/Virtual/logica/ConsultaImpuesto.php",
                data: parametros,
