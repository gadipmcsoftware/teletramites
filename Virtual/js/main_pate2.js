...
//
            if ( newIndex === 2 ) {
                $('.steps ul li:nth-child(3) a img').attr('src','images/paso-4-active.png');
                $('.actions ul').addClass('step-4');
            } else {
                $('.steps ul li:nth-child(3) a img').attr('src','images/paso-4.png');
...
//    $('.steps ul li:nth-child(2').append('<img src="images/step-arrow.png" alt="" class="step-arrow">').find('a').append('<img src="images/paso-2.png" alt="">').append('<span class="step-order">Información Establecimientos</span>');
    $('.steps ul li:nth-child(2)').append('<img src="images/step-arrow.png" alt="" class="step-arrow">').find('a').append('<img src="images/paso-3.png" alt="">').append('<span class="step-order">Información Contable</span>');
