...
//                                     alert(identificacion+","+nombres+","+apellidos+","+direccion+","+telefono+","+email+","+notifi+","+cam_clave+","+clave+","+titulo+","+cuidad+","+valid_profe+","+snsit+","+cod_perfil+","+es_contri+","+pro_codigo+","+dir_ip+","+cre_pro+","+cod_provincia+","+cod_canton+","+cod_parroquia+","+personeria+","+acept);
                                        ...
                                        window.location.href = "http://172.23.25.6/Virtual/Login.php";
                                }
                                else{
                                     var valid_profe=1;
                                     GuardarPropie(identificacion,nombres,apellidos,direccion,telefono,email,notifi,cam_clave,clave,titulo,cuidad,valid_profe,snsit,cod_perfil,es_contri,pro_codigo,dir_ip,cre_pro,cod_provincia,cod_canton,cod_parroquia,personeria,acept,fecha_nac);
...
su clave es: '+clave+' \n\
Recuerde que en esta plataforma puede dar seguimiento a sus tramites Municipales.');
                                    window.location.href = "http://172.23.25.6/Virtual/register.php";
                             }          
                    }
      ...
      $('#TBL_BANDASU tbody').on( 'click', 'a', function () {
                       ...
                       if($(this).attr('id')=="Btn_eli"){
                        ...
                        if($(this).attr('id')=="Btn_descar"){
                             rowDataArchivo = tbl_bandasu.row( $(this).parents('tr') ).data();
                              window.location.href ="http://172.23.25.6/Virtual/logica/descarga.php?file="+rowDataArchivo[3];
                       }
        });
         $('#Btn_enviar').on('click', function (e){
          ...
          sessionStorage.setItem('Archivos',JSON.stringify(DataSetArchivos));
           var aduntos=tbl_bandasu.rows().count();
            ...
            var SP_id=sessionStorage.getItem('SpId')
            if(SP_id!=null&&aduntos>0){
//                   alert(SP_fin+","+SP_id);
                   EjecutaAcciones(SP_fin,SP_id);
            }
...
//             alert(personeria);
             ...
             if(UsrExt==1&&Data_SetRequisito.length>0&&tbl_bandasu.rows().count()==0){
                 ...
                 $('#Modal_body').load('http://172.23.25.6/Virtual/wizar.php',function(){
...
//                            var Spid=sessionStorage.getItem('Cod_Pat');
//                            alert(Spid);
//                            if (isNaN(Spid)){
...
//                            }
        ...
        //                    alert(rowResultadoAc[0][0]);                     
                 ...
                 if (rowDataAccion[5]!==null&&rowDataAccion[3]!==null){
                     SP_fin=rowDataAccion[3];
                 }
             }
      ...
      window.location.href = "http://172.23.25.6/Virtual/error.php";
        ...
        if(UsrExt==0){
           $('.btn-dark').removeClass("btn-dark").addClass('btn-primary');
            ...
            var validasimula=parseInt(sessionStorage.getItem('PRE_SIMULA'));
//                alert(validasimula);
                if (validasimula==1) {
...
function Propietarios(){
   ...
   var ex=0; 
     try {
					...
					async: false,
					cache: false,
					url: "http://172.23.25.6/Virtual/logica/TraerPropie.php",
...
function TraerTipTramite(perfil,Usrext,area,accion){
   var ex=0; 
     try {
					...
					async: false,
					cache: false,
					url: "http://172.23.25.6/Virtual/logica/TraerTipTramite.php",
                                        data: parametros,
					success: function(response){                                           
						 if(JSON.parse(response.ind)){
                                                               ex=response.ind; 
...
function DatosEstados(){
   ...
   var ex=0; 
     try {
					...
					async: false,
					cache: false,
					url: "http://172.23.25.6/Virtual/logica/ConsEstado.php",
					data: parametros,
					success: function(response){                                           
						 if(JSON.parse(response.ind)){
                                                               ex=response.ind; 
    ...
    try {
        ...
        //                                   
                                        $.ajax({
                                                ...
                                                async: false,
                                                cache: false,
                                                url: "http://172.23.25.6/Virtual/logica/GrabarProfe.php",
                                                data: parametros,
                                                success: function(response){                                           
                                                        if(JSON.parse(response.ind)){
                                                               ex=response.ind; 
...
//					dataType: "json",
					async: false,
					cache: false,
					url: "http://172.23.25.6/Virtual/logica/Eliminar.php",
					data: parametros,
//                                        error: function(xhr, textStatus, errorMessage) {
//                                                                alert("¡Error (ajax)!"+ errorMessage + textStatus + xhr);
//                                        }
...
function TraerAdjuntos(id){
   ...
   var ex=0; 
     try {
					...
					async: false,
					cache: false,
					url: "http://172.23.25.6/Virtual/logica/TraerAdjuntos.php",
					data: parametros,
					success: function(response){                                           
						 if(JSON.parse(response.ind)){
                                                               ex=response.ind; 
...
function TraerFuncionarios(id){
   ...
   var ex=0; 
     try {
					...
					async: false,
					cache: false,
					url: "http://172.23.25.6/Virtual/logica/TraerFuncionarios.php",
					data: parametros,
					success: function(response){                                           
						 if(JSON.parse(response.ind)){
                                                               ex=response.ind; 
    ...
    try {
        ...
        //                                   
                                        $.ajax({
                                                ...
                                                async: false,
                                                cache: false,
                                                url: "http://172.23.25.6/Virtual/logica/Reasignar.php",
                                                data: parametros,
                                                 success: function(response){                                           
                                                        if(JSON.parse(response.ind)){
                                                               ex=response.ind; 
...
function Perfiles(){
   ...
   var ex=0; 
     try {
					...
					async: false,
					cache: false,
					url: "http://172.23.25.6/Virtual/logica/TraePerfil.php",
					success: function(response){                                           
						 if(JSON.parse(response.ind)){
                                                               ex=response.ind; 
...
function Personeria(){
   ...
   var ex=0; 
     try {
					...
					async: false,
					cache: false,
					url: "http://172.23.25.6/Virtual/logica/TraePersoneria.php",
					success: function(response){                                           
						 if(JSON.parse(response.ind)){
                                                               ex=response.ind; 
...
function TraerSubTramite(perfil,Usrext,area,tip_tra,accion){
   var ex=0; 
     try {
					...
					async: false,
					cache: false,
					url: "http://172.23.25.6/Virtual/logica/TraeSubTramite.php",
                                        data: parametros,
					success: function(response){                                           
						 if(JSON.parse(response.ind)){
                                                               ex=response.ind; 
...
function DatosProfecional(id){
   ...
   var ex=0; 
     try {
					...
					async: false,
					cache: false,
					url: "http://172.23.25.6/Virtual/logica/ConsuProfe.php",
					data: parametros,
					success: function(response){                                           
						 if(JSON.parse(response.ind)){
                                                               ex=response.ind; 
...
function Requisitos(cod_tra,personeria){
   ...
   var ex=0; 
     try {
					...
					async: false,
					cache: false,
					url: "http://172.23.25.6/Virtual/logica/TraeRequisitos.php",
					data: parametros,
					success: function(response){                                           
						 if(JSON.parse(response.ind)){
                                                               ex=response.ind; 
...
function TraeAcciones_re(cod_tip_tra,cod_esta_tra){
   ...
   var ex=0; 
     try {
					...
					async: false,
					cache: false,
					url: "http://172.23.25.6/Virtual/logica/TraerAcciones.php",
					data: parametros,
					success: function(response){                                           
						 if(JSON.parse(response.ind)){
                                                               ex=response.ind; 
...
function EjecutaAcciones(nom_sp,id){
     ...
     try {
					...
					async: false,
					cache: false,
					url: "http://172.23.25.6/Virtual/logica/GeneraAcciones.php",
					data: parametros,
					success: function(response){                                           
						 if(JSON.parse(response.ind)){
                                                               ex=response.ind; 
    ...
    try {
        ...
        //                                   
                                        $.ajax({
                                                ...
                                                async: false,
                                                cache: false,
                                                url: "http://172.23.25.6/Virtual/logica/GrabarTramite.php",
                                                data: parametros,
                                                 success: function(response){                                           
                                                        if(JSON.parse(response.ind)){
                                                               ex=response.ind; 
    ...
    try {
        ...
        //                                   
                                        $.ajax({
                                                ...
                                                async: false,
                                                cache: false,
                                                url: "http://172.23.25.6/Virtual/logica/GrabarAdjuntos.php",
                                                data: parametros,
                                                 success: function(response){                                           
                                                        if(JSON.parse(response.ind)){
                                                               ex=response.ind; 
