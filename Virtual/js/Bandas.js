    ...
    try {
        ...
        //                                   
                                        $.ajax({
                                                ...
                                                async: false,
                                                cache: false,
                                                url: "http://172.23.25.6/Virtual/logica/GuardaBandas.php",
                                                data: parametros,
 ...
 function TraeBienio(){
   ...
   var ex=0; 
     try {
					...
					async: false,
					cache: false,
					url: "http://172.23.25.6/Virtual/logica/ConsultaBienio.php",
					success: function(response){                                           
						 if(JSON.parse(response.ind)){
                                                               ex=response.ind; 
...
//        alert(cod_bienio);
                                        ...
                                        $.ajax({
                                                ...
                                                async: false,
                                                cache: false,
                                                url: "http://172.23.25.6/Virtual/logica/ConsultaBandasImpositivas.php",
                                                data: parametros,
                                                success: function(response){                                           
                                                           if(JSON.parse(response.ind)){
                                                               ex=response.ind; 
    ...
    try {
        ...
        //                                   
                                        $.ajax({
                                                ...
                                                async: false,
                                                cache: false,
                                                url: "http://172.23.25.6/Virtual/logica/TraeMaximos.php",
                                                data: parametros,
                                                success: function(response){                                           
                                                        if(JSON.parse(response.ind)){
                                                               ex=response.ind;
