...
<?php include 'menu.php';?>
        <!-- Begin Page Content -->
<form method="POST" id="Frm_CharR">
     
        <div class="container-fluid">

          <!-- Page Heading -->
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Dashboard Grafico de Impuestos</h1>
<!--            <a href="#" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-download fa-sm text-white-50"></i> Generate Report</a>-->
          </div>
           <div class="card shadow mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 id="lbl_Impac" class="m-0 font-weight-bold text-primary">Parametros de Simulacion</h6>
          ...
          <div class="row">
              ...
              <div class="card border-left-primary shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Impuesto Rural</div>
                      <div id='arecaudar' class="h5 mb-0 font-weight-bold text-gray-800"></div>
                    </div>
                    <div class="col-auto">
           ...
           <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  ...
                  <div id="divBarBandR" style = "display:none" class="chart-bar">
                    <canvas id="myBarChartR"></canvas>
                  </div>
                 <div id="divBarBand2" style = "display:none" class="chart-bar">
                    <canvas id="myBarChart2"></canvas>
                 </div>
                 <div id="divBarBandR2" style = "display:none" class="chart-bar">
                    <canvas id="myBarChartR2"></canvas>
                 </div>
                </div>
            </div>
           <div class="card shadow mb-4">
...
<script type="text/javascript">
  ...
  <script src="js/demo/chart_bar_band_r.js"></script>
</form>
</body>
